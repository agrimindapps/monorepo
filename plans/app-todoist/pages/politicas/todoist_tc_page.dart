...
class TodoistTermosPage extends StatefulWidget {
  const TodoistTermosPage({super.key});

  @override
  State<TodoistTermosPage> createState() => _TodoistTermosPageState();
}

class _TodoistTermosPageState extends State<TodoistTermosPage> {
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildParagraph(
                  'Bem-vindo ao TodoApp! Estes Termos e Condições ("Termos") regem o uso do nosso aplicativo móvel TodoApp ("Serviço") operado pela Agrimind Apps ("nós", "nosso" ou "nos").'),
              const SizedBox(height: 16),
              _buildParagraph(
              ...
              const SizedBox(height: 16),
              _buildParagraph(
                  'O TodoApp é destinado ao gerenciamento de tarefas e produtividade pessoal, fornecendo organização de listas de afazeres, lembretes e controle de prazos.'),
            ],
          ),
        ),
      ),
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              _buildParagraph(
                  'O aplicativo TodoApp armazena e processa dados pessoais que você nos forneceu, para fornecer nosso Serviço. É sua responsabilidade manter seu telefone e o acesso ao aplicativo seguros.'),
              const SizedBox(height: 16),
              _buildParagraph('Você é responsável por:'),
              const SizedBox(height: 12),
              _buildBulletPoint(
                  'Manter a precisão das suas tarefas e informações de produtividade;'),
              _buildBulletPoint(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              _buildParagraph(
                  'O TodoApp fornece ferramentas para organização de tarefas e produtividade, mas não garante melhoria específica em produtividade ou cumprimento de prazos. É sua responsabilidade:'),
              const SizedBox(height: 12),
              _buildBulletPoint(
                  'Inserir informações precisas sobre suas tarefas e prazos;'),
              _buildBulletPoint(
                  'Gerenciar adequadamente seu tempo e compromissos;'),
              _buildBulletPoint(
                  'Usar o aplicativo como uma ferramenta auxiliar de organização;'),
              _buildBulletPoint(
                  'Tomar decisões informadas sobre priorização de tarefas.'),
              const SizedBox(height: 16),
              _buildParagraph(
                  'A Agrimind Apps não se responsabiliza por compromissos perdidos, tarefas não concluídas ou perdas resultantes do uso das informações fornecidas pelo aplicativo. O aplicativo não substitui planejamento pessoal adequado.'),
            ],
          ),
        ),
      ),
