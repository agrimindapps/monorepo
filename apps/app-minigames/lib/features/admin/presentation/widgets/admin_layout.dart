...
/// Layout base para páginas administrativas do MiniGames
/// 
/// Tema: Dourado/Gaming (#FFD700)
class AdminLayout extends StatelessWidget {
  ...
  static const _primaryColor = Color(0xFFFFD700); // Gold
  static const _primaryDark = Color(0xFFDAA520); // Dark gold
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: isDark ? _bgDark : Colors.grey.shade50,
