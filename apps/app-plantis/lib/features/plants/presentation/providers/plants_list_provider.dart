...
class PlantsListProvider extends ChangeNotifier with ErrorHandlingMixin {
  ...
  Future<void> loadPlants() async {
    ...
    final plants = await handleEitherOperation(() => _plantsRepository.getPlants());
  ...
  Future<void> addPlant(Plant plant) async {
    final addedPlant = await handleEitherOperation(() => _plantsRepository.addPlant(plant));
  ...
  Future<void> updatePlant(Plant plant) async {
    final updatedPlant = await handleEitherOperation(() => _plantsRepository.updatePlant(plant));
  ...
  Future<void> deletePlant(String id) async {
    final success = await handleEitherOperation(() => _plantsRepository.deletePlant(id));
  ...
  Future<void> performRemoteSearch(String query) async {
    ...
    final searchResults = await handleEitherOperation(() => _plantsRepository.searchPlants(query));
  ...
  List<Plant> getPlantsBySpace(String spaceId) {
    final plantsToFilter = _filteredPlants.isEmpty && _searchQuery.isEmpty 
        ? _plants 
        : _filteredPlants;
