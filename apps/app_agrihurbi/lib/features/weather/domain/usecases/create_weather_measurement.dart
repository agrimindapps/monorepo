  ...
  Future<Either<WeatherFailure, WeatherMeasurementEntity>> fromSensorData({
    ...
    try {
      ...
      final measurement = WeatherMeasurementEntity(
        ...
        locationId: locationId,
        locationName: locationName,
        timestamp: parsedData['timestamp'] ?? DateTime.now(),
        temperature: parsedData['temperature'] ?? 0.0,
        humidity: parsedData['humidity'] ?? 0.0,
        pressure: parsedData['pressure'] ?? 1013.25,
        windSpeed: parsedData['windSpeed'] ?? 0.0,
        windDirection: parsedData['windDirection'] ?? 0.0,
        rainfall: parsedData['rainfall'] ?? 0.0,
        uvIndex: parsedData['uvIndex'] ?? 0.0,
        visibility: parsedData['visibility'] ?? 10.0,
        weatherCondition: parsedData['weatherCondition'] ?? 'unknown',
        description: parsedData['description'] ?? 'Sensor measurement',
        latitude: latitude,
        longitude: longitude,
  ...
  Future<Either<WeatherFailure, WeatherMeasurementEntity>> fromApiData({
    ...
    try {
      ...
      final measurement = WeatherMeasurementEntity(
        ...
        visibility: parsedData['visibility'] ?? 10.0,
        weatherCondition: parsedData['weatherCondition'] ?? 'unknown',
        description: parsedData['description'] ?? 'API measurement',
        latitude: latitude,
        longitude: longitude,
