class ConsultaDateUtils {
  ...
  static String formatDataHora(DateTime date) {
    return '${formatData(date)} às ${date.hour.toString().padLeft(2, '0')}:${date.minute.toString().padLeft(2, '0')}';
  }
  ...
  static String formatDateTimeForExport(DateTime date) {
    return date.toIso8601String();
  }

  static DateTime? parseDateTimeFromExport(String dateString) {
    try {
