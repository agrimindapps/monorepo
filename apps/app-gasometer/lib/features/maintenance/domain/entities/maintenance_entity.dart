...
class MaintenanceEntity extends BaseSyncEntity {
  ...
  MaintenanceEntity copyWith({
    ...
    return MaintenanceEntity(
      ...
      workshopPhone: clearWorkshop
          ? null
          : (workshopPhone ?? this.workshopPhone),
      workshopAddress: clearWorkshop
          ? null
          : (workshopAddress ?? this.workshopAddress),
      nextServiceDate: clearNextService
          ? null
          : (nextServiceDate ?? this.nextServiceDate),
      nextServiceOdometer: clearNextService
          ? null
  ...
  bool get hasWorkshopInfo =>
      workshopName != null && workshopName!.trim().isNotEmpty;
