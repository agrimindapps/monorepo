...
class MobilePageNutriTuti extends StatefulWidget {
  const MobilePageNutriTuti({super.key});

  @override
  State<MobilePageNutriTuti> createState() => _MobilePageNutriTutiState();
}

class _MobilePageNutriTutiState extends State<MobilePageNutriTuti>
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              // Toggle tema claro/escuro (exemplo, ajuste conforme seu sistema de tema)
              Get.changeThemeMode(
