...
class CalculatorFeaturesProvider extends ChangeNotifier {
  ...
  Future<void> loadFavorites() async {
    ...
    try {
      ...
      debugPrint('CalculatorFeaturesProvider: Favoritos carregados - ${_favoriteIds.length} itens');
    } catch (e) {
  ...
  Future<bool> toggleFavorite(String calculatorId) async {
    try {
      ...
      if (success) {
        ...
        debugPrint('CalculatorFeaturesProvider: Favorito alternado - $calculatorId');
        return true;
      }
      return false;
    } catch (e) {
  ...
  Future<bool> addToFavorites(String calculatorId) async {
    try {
      ...
      if (success) {
        await loadFavorites();
        debugPrint('CalculatorFeaturesProvider: Adicionado aos favoritos - $calculatorId');
        return true;
      }
      return false;
    } catch (e) {
  ...
  Future<bool> removeFromFavorites(String calculatorId) async {
    try {
      ...
      if (success) {
        await loadFavorites();
        debugPrint('CalculatorFeaturesProvider: Removido dos favoritos - $calculatorId');
        return true;
      }
      return false;
    } catch (e) {
  ...
  Future<void> loadTemplates() async {
    ...
    try {
      ...
      debugPrint('CalculatorFeaturesProvider: Templates carregados - ${_templates.length} itens');
    } catch (e) {
  ...
  Future<List<CalculationTemplate>> getTemplatesForCalculator(String calculatorId) async {
    try {
      ...
      debugPrint('CalculatorFeaturesProvider: Erro ao carregar templates da calculadora - $e');
      return [];
    }
  }
  ...
  Future<bool> saveTemplate(CalculationTemplate template) async {
    try {
      ...
      if (success) {
        ...
        debugPrint('CalculatorFeaturesProvider: Template salvo - ${template.name}');
        return true;
      }
      return false;
    } catch (e) {
  ...
  Future<bool> deleteTemplate(String templateId) async {
    try {
      ...
      if (success) {
        await loadTemplates(); // Recarrega lista
        debugPrint('CalculatorFeaturesProvider: Template removido - $templateId');
        return true;
      }
      return false;
    } catch (e) {
  ...
  Future<bool> markTemplateAsUsed(String templateId) async {
    try {
      ...
      if (success) {
        ...
        debugPrint('CalculatorFeaturesProvider: Template marcado como usado - $templateId');
        return true;
      }
      return false;
    } catch (e) {
      debugPrint('CalculatorFeaturesProvider: Erro ao marcar template como usado - $e');
      return false;
    }
  }
  ...
  Future<List<CalculationTemplate>> getRecentTemplates({int limit = 5}) async {
    try {
      ...
      debugPrint('CalculatorFeaturesProvider: Erro ao obter templates recentes - $e');
      return [];
    }
  }
  ...
  Future<List<CalculationTemplate>> getPopularTemplates({int limit = 5}) async {
    try {
      ...
      debugPrint('CalculatorFeaturesProvider: Erro ao obter templates populares - $e');
      return [];
    }
  }
  ...
  String generateCalculatorShareLink(String calculatorId, String calculatorName) {
  ...
  String generateCalculatorShareText(String calculatorName, String description) {
  ...
  String _generateCSVResult(
    ...
    for (final entry in outputs.entries) {
      csv += '"$calculatorName",Resultado,"${entry.key}","${entry.value}","$timestamp"\n';
    }
