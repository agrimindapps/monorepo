...
class DefensivoSearchField extends StatefulWidget {
  ...
  @override
  State<DefensivoSearchField> createState() => _DefensivoSearchFieldState();
}

class _DefensivoSearchFieldState extends State<DefensivoSearchField>
  ...
  Widget _buildViewToggleButtons() {
    return Container(
      ...
      child: Row(
        ...
        children: [
          _buildToggleButton(ViewMode.grid, ViewMode.grid.icon),
          _buildToggleButton(ViewMode.list, ViewMode.list.icon),
        ],
      ),
    );
  }
