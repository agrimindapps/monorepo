...
/// Widget unificado para exibição de imagens no Petiveti
///
...
class UnifiedImageWidget extends StatefulWidget {
  ...
  /// Se a imagem deve ser circular
  final bool isCircular;

  /// Factory para imagens de animais/pets
  factory UnifiedImageWidget.animal({
    Key? key,
    String? imageBase64,
    String? imagePath,
    double size = 80,
  ...
  /// Factory para avatar pequeno (lista)
  factory UnifiedImageWidget.avatar({
    Key? key,
    String? imageBase64,
    String? imagePath,
    double size = 48,
  ...
  /// Factory para imagem grande (detalhes)
  factory UnifiedImageWidget.large({
    Key? key,
    String? imageBase64,
    String? imagePath,
  ...
  Widget _buildPlaceholder() {
    ...
    return Container(
      ...
      child: Icon(
        ...
        size: (widget.width + widget.height) / 6,
