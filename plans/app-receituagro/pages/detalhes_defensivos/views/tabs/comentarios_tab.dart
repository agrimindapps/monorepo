...
class ComentariosTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      ...
      final caracteristicasData = defensivoData.caracteristicas;
      final pkIdentificador = caracteristicasData['idReg']?.toString() ??
          caracteristicasData['id']?.toString() ??
          '';
      final ferramenta =
          'Defensivos - ${caracteristicasData['nomeComum'] ?? 'Produto'}';
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Adicione o primeiro comentário sobre este defensivo',
