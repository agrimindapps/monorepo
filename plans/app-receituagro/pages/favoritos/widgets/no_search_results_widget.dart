...
/// Widget para exibir quando a busca não retorna resultados
/// Diferente do EmptyStateWidget que é para quando não há favoritos
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Não encontramos favoritos com "$searchText"',
