...
class PetiVetiTermosPage extends StatefulWidget {
  const PetiVetiTermosPage({super.key});

  @override
  State<PetiVetiTermosPage> createState() => _PetiVetiTermosPageState();
}

class _PetiVetiTermosPageState extends State<PetiVetiTermosPage> {
              ...
              if (isMobile)
                ...
                Row(
                  children: [
                    ...
                    _navBarButton('Terceiros', () => _scrollToSection(_thirdPartySection)),
                    _navBarButton('Responsabilidades', () => _scrollToSection(_responsibilitiesSection)),
                    _navBarButton('Atualizações', () => _scrollToSection(_updatesSection)),
                    _navBarButton('Alterações', () => _scrollToSection(_changesSection)),
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildParagraph(
                  'Bem-vindo ao PetiVeti! Estes Termos e Condições ("Termos") regem o uso do nosso aplicativo móvel PetiVeti ("Serviço") operado pela Agrimind Apps ("nós", "nosso" ou "nos").'),
              const SizedBox(height: 16),
              _buildParagraph(
              ...
              const SizedBox(height: 16),
              _buildParagraph(
                  'O PetiVeti é destinado ao gerenciamento veterinário e cuidados com animais de estimação, fornecendo controle de vacinas, consultas, medicamentos e registros de saúde dos pets.'),
            ],
          ),
        ),
      ),
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              _buildParagraph(
                  'O aplicativo PetiVeti armazena e processa dados pessoais que você nos forneceu, para fornecer nosso Serviço. É sua responsabilidade manter seu telefone e o acesso ao aplicativo seguros.'),
              const SizedBox(height: 16),
              _buildParagraph(
                  'Você é responsável por:'),
              const SizedBox(height: 12),
              _buildBulletPoint('Manter a precisão das informações de saúde dos seus pets;'),
              _buildBulletPoint('Usar o aplicativo de acordo com suas funcionalidades pretendidas;'),
              _buildBulletPoint('Não usar o aplicativo para fins ilegais ou não autorizados;'),
              _buildBulletPoint('Respeitar os direitos de propriedade intelectual do aplicativo.'),
            ],
          ),
        ),
      ),
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              _buildParagraph(
                  'O PetiVeti fornece ferramentas para gerenciamento veterinário e lembretes de cuidados, mas não substitui consultas veterinárias profissionais. É sua responsabilidade:'),
              const SizedBox(height: 12),
              _buildBulletPoint('Consultar veterinários qualificados para diagnósticos e tratamentos;'),
              _buildBulletPoint('Verificar informações médicas com profissionais veterinários;'),
              _buildBulletPoint('Usar o aplicativo como uma ferramenta auxiliar de organização;'),
              _buildBulletPoint('Tomar decisões informadas sobre a saúde dos seus pets.'),
              const SizedBox(height: 16),
              _buildParagraph(
                  'A Agrimind Apps não se responsabiliza por danos à saúde dos animais ou perdas resultantes do uso das informações fornecidas pelo aplicativo. O aplicativo não oferece aconselhamento médico veterinário.'),
            ],
          ),
        ),
      ),
