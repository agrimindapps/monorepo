...
/// Widget reutilizável para botões de autenticação do ReceitaAgro
...
class AuthButtonWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final primaryColor = backgroundColor ?? _getReceitaAgroPrimaryColor(isDark);
    ...
    return SizedBox(
      ...
      height: height,
      child: isSecondary 
          ? _buildOutlinedButton(context, primaryColor, isDark) 
          : _buildElevatedButton(context, primaryColor, textColor, isDark),
    );
  }
