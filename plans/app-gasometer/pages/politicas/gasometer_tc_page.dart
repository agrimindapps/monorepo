...
class GasOMeterTermosPage extends StatefulWidget {
  const GasOMeterTermosPage({super.key});

  @override
  State<GasOMeterTermosPage> createState() => _GasOMeterTermosPageState();
}

class _GasOMeterTermosPageState extends State<GasOMeterTermosPage> {
