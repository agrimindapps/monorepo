...
/// Controller padronizado para autenticação do módulo AgriHurbi
class AgrihurbiAuthController extends GetxController {
  ...
  static const ModuleAuthConfig _moduleConfig = ModuleAuthConfig.agrihurbi;
  ...
  final RxBool _showRecoveryForm = false.obs;
  ...
  bool get showRecoveryForm => _showRecoveryForm.value;
  ...
  void showRecoveryFormAction() {
    _showRecoveryForm.value = true;
    _clearError();
  }

  void hideRecoveryFormAction() {
    _showRecoveryForm.value = false;
    _clearError();
  }
  ...
  Future<void> signInWithEmail() async {
    ...
    try {
      ...
      if (result.success && result.user != null) {
        _showSuccessMessage(
            'Login realizado com sucesso!', 'Bem-vindo ao AgriHurbi');
    ...
    try {
      ...
      if (result.success && result.user != null) {
        _showSuccessMessage('Conta criada com sucesso!',
            'Bem-vindo ao AgriHurbi, ${nameController.text}');
