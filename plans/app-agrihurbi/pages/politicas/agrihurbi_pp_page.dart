...
class AgriHurbiPoliticaPage extends StatefulWidget {
  const AgriHurbiPoliticaPage({super.key});

  @override
  State<AgriHurbiPoliticaPage> createState() => _AgriHurbiPoliticaPageState();
}

class _AgriHurbiPoliticaPageState extends State<AgriHurbiPoliticaPage> {
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildParagraph(
                  'A Agrimind Apps construiu o aplicativo CalcAgro como um aplicativo suportado por anúncios. Este SERVIÇO é fornecido pela Agrimind Apps sem custo e destina-se ao uso como está.'),
              const SizedBox(height: 16),
              _buildParagraph(
              ...
              const SizedBox(height: 16),
              _buildParagraph(
                  'Os termos utilizados nesta Política de Privacidade têm os mesmos significados que em nossos Termos e Condições, que são acessíveis em CalcAgro, salvo definição em contrário nesta Política de Privacidade.'),
            ],
          ),
        ),
      ),
