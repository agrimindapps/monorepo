...
abstract class TasksRepository {
  ...
  Future<Either<Failure, List<task_entity.Task>>> getTasksByPlantId(String plantId);
  Future<Either<Failure, List<task_entity.Task>>> getTasksByStatus(task_entity.TaskStatus status);
  ...
  Future<Either<Failure, task_entity.Task>> completeTask(String id, {String? notes});
  Future<Either<Failure, void>> markTaskAsOverdue(String id);
  Future<Either<Failure, task_entity.Task>> createRecurringTask(task_entity.Task completedTask);
}