...
1. O `PremiumNotifier` é inicializado.
...
## 🛠 Arquivos Principais
- `lib/core/database/plantis_tables.dart`: Definição da tabela.
- `lib/features/premium/data/repositories/subscription_local_repository.dart`: Repositório local.
- `lib/features/premium/presentation/providers/premium_notifier.dart`: Gerenciador de estado atualizado.
