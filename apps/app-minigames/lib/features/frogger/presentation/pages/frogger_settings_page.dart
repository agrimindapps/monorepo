...
class FroggerSettingsPage extends ConsumerWidget {
  const FroggerSettingsPage({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final settingsAsync = ref.watch(froggerSettingsProvider);

    return GamePageLayout(
      title: 'Configurações - Frogger',
        ...
        data: (settings) => SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              _SectionTitle(title: 'Velocidade do Tráfego'),
              Card(
                color: Colors.black.withValues(alpha: 0.3),
                child: Padding(
                  padding: const EdgeInsets.all(16),
                  child: Column(
                    children: FroggerDifficulty.values.map((difficulty) {
                      return RadioListTile<FroggerDifficulty>(
  ...
  void _updateSettings(WidgetRef ref, FroggerSettings settings) {
    final updater = ref.read(froggerSettingsUpdaterProvider.notifier);
