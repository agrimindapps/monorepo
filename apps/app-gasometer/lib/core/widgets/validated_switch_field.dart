...
class _ValidatedSwitchFieldState extends State<ValidatedSwitchField>
  ...
  Widget _buildSwitch() {
    return Switch(
      ...
      activeColor: widget.activeColor ?? GasometerDesignTokens.colorPrimary,
    ...
    return Column(
      ...
      children: [
        InkWell(
          ...
          child: Padding(
            padding: GasometerDesignTokens.paddingAll(GasometerDesignTokens.spacingXs),
        ...
        Column(
          children: widget.items.map((item) {
            ...
            return ValidatedSwitchField(
              value: isSelected,
              onChanged: widget.enabled ? (value) => _onItemChanged(item.key, value) : null,
              label: item.label,
