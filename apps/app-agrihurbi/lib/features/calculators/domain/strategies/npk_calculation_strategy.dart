  ...
  List<CalculationResultValue> _buildResultValues(
    ...
    return [
      CalculationResultValue(
        label: 'Nitrogênio (N)',
        initialValue: _roundTo(netNeeds.nitrogen, 1),
        unit: 'kg/ha',
      ...
      CalculationResultValue(
        label: 'Fósforo (P₂O₅)',
        initialValue: _roundTo(netNeeds.phosphorus, 1),
        unit: 'kg/ha',
      ...
      CalculationResultValue(
        label: 'Potássio (K₂O)',
        initialValue: _roundTo(netNeeds.potassium, 1),
        unit: 'kg/ha',
      ...
      CalculationResultValue(
        ...
        initialValue: _roundTo(netNeeds.nitrogen * area, 0),
        unit: 'kg',
        description: 'Nitrogênio total para $area ha',
      ),
      CalculationResultValue(
        label: 'Total P₂O₅ para Área',
        initialValue: _roundTo(netNeeds.phosphorus * area, 0),
        unit: 'kg',
        description: 'Fósforo total para $area ha',
      ),
      CalculationResultValue(
        label: 'Total K₂O para Área',
        initialValue: _roundTo(netNeeds.potassium * area, 0),
        unit: 'kg',
        description: 'Potássio total para $area ha',
      ),
      CalculationResultValue(
        label: 'Custo Estimado',
        initialValue: _roundTo(estimatedCost * area, 0),
        unit: 'R\$',
