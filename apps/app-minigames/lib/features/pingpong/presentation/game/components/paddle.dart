...
class Paddle extends PositionComponent with CollisionCallbacks, HasGameRef<PingPongGame> {
  final bool isPlayer;
  ...
  void render(Canvas canvas) {
    ...
    final innerRRect = RRect.fromRectAndRadius(innerRect, const Radius.circular(5));
