...
class FuelFormModel extends Equatable {
  ...
  factory FuelFormModel.fromFuelRecord(FuelRecordEntity record) {
    return FuelFormModel(
      ...
      fuelType: record.tipoCombustivel,
      liters: record.litros,
      pricePerLiter: record.precoPorLitro,
      totalPrice: record.valorTotal,
      odometer: record.odometro,
      date: record.data,
      gasStationName: record.nomePosto ?? '',
      gasStationBrand: record.marcaPosto ?? '',
