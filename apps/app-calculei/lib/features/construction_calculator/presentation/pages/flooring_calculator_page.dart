...
class _FlooringCalculatorPageState
    extends ConsumerState<FlooringCalculatorPage> {
                  ...
                  Card(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text(
                            'Calcular quantidade de piso/revestimento',
                            style: TextStyle(
                              fontSize: 18,
  ...
  void _showInfo(BuildContext context) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: const Text('Piso/Revestimento'),
        content: const SingleChildScrollView(
          child: Text(
            'Esta calculadora determina a quantidade de peças necessárias para piso ou revestimento.\n\n'
            'Como funciona:\n'
            '• Área total em metros quadrados\n'
            '• Dimensões das peças (largura × comprimento em cm)\n'
            '• Percentual de perda (quebra, corte, etc.)\n\n'
            'Fatores importantes:\n'
            '• Perda padrão: 10% (recomendado)\n'
            '• Para áreas irregulares: aumentar a perda\n'
            '• Considerar rejunte e argamassa\n'
            '• Comprar unidades a mais para reposições\n\n'
            'Dicas:\n'
            '• Meça a área real da obra\n'
            '• Considere o sentido do assentamento\n'
            '• Calcule perdas por cortes\n'
            '• Adicione margem para eventuais quebras\n\n'
            'O cálculo considera a área útil e adiciona o percentual de perda.',
          ),
        ),
        actions: [
          TextButton(
