    ...
    return GamePageLayout(
      ...
      child: AspectRatio(
        ...
        child: GameWidget<ArkanoidGame>(
          game: _game,
          overlayBuilderMap: {
            'PauseMenu': (context, game) => PauseMenuOverlay(onContinue: game.resumeGame, onRestart: game.reset, accentColor: const Color(0xFFFF5722)),
  ...
  Widget _buildOverlay(String title, String subtitle, Color color, VoidCallback onRestart) {
    return Center(
      child: Container(
        ...
        decoration: BoxDecoration(color: Colors.black.withValues(alpha: 0.9), borderRadius: BorderRadius.circular(16), border: Border.all(color: color, width: 2)),
        child: Column(
