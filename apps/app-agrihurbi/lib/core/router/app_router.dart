          ...
          GoRoute(
            ...
            routes: [
              ...
              GoRoute(
                ...
                builder: (context, state) =>
                    const CalculatorsListPage(category: 'nutrition'),
                routes: [
                  GoRoute(
                    path: 'npk',
                    name: 'npk-calculator',
                    builder: (context, state) => const CalculatorDetailPage(
                  ...
                  GoRoute(
                    ...
                    builder: (context, state) => const CalculatorDetailPage(
                      calculatorId: 'soil_ph_calculator',
                    ),
                  ),
                  GoRoute(
                    ...
                    builder: (context, state) => const CalculatorDetailPage(
                      calculatorId: 'fertilizer_dosing_calculator',
                    ),
                  ),
                  GoRoute(
                    path: 'compost',
                    ...
                    builder: (context, state) => const CalculatorDetailPage(
                      calculatorId: 'compost_calculator',
                    ),
                  ),
                  GoRoute(
                    ...
                    builder: (context, state) => const CalculatorDetailPage(
                      calculatorId: 'organic_fertilizer_calculator',
                    ),
                  ),
                ],
              ),
              GoRoute(
                ...
                builder: (context, state) =>
                    const CalculatorsListPage(category: 'livestock'),
                routes: [
                  GoRoute(
                    path: 'feed',
                    name: 'feed-calculator',
                    builder: (context, state) => const CalculatorDetailPage(
                      calculatorId: 'feed_calculator',
                    ),
                  ),
                  GoRoute(
                    path: 'breeding-cycle',
                    ...
                    builder: (context, state) => const CalculatorDetailPage(
                      calculatorId: 'breeding_cycle_calculator',
                    ),
                  ),
                  GoRoute(
                    path: 'grazing',
                    ...
                    builder: (context, state) => const CalculatorDetailPage(
                      calculatorId: 'grazing_calculator',
                    ),
                  ),
                  GoRoute(
                    path: 'weight-gain',
                    ...
                    builder: (context, state) => const CalculatorDetailPage(
                      calculatorId: 'weight_gain_calculator',
                    ),
                  ),
                ],
              ),
              GoRoute(
                ...
                builder: (context, state) =>
                    const CalculatorsListPage(category: 'crops'),
                routes: [
                  GoRoute(
                    path: 'planting-density',
                    name: 'planting-density-calculator',
                    builder: (context, state) => const CalculatorDetailPage(
                      calculatorId: 'planting_density_calculator',
                    ),
                  ),
                  GoRoute(
                    path: 'harvest-timing',
                    ...
                    builder: (context, state) => const CalculatorDetailPage(
                      calculatorId: 'harvest_timing_calculator',
                    ),
                  ),
                  GoRoute(
                    path: 'seed-rate',
                    ...
                    builder: (context, state) => const CalculatorDetailPage(
                      calculatorId: 'seed_rate_calculator',
                    ),
                  ),
                  GoRoute(
                    ...
                    builder: (context, state) => const CalculatorDetailPage(
                      calculatorId: 'yield_prediction_calculator',
                    ),
                  ),
                ],
              ),
              GoRoute(
                ...
                builder: (context, state) =>
                    const CalculatorsListPage(category: 'soil'),
                routes: [
                  GoRoute(
                    path: 'composition',
                    name: 'soil-composition-calculator',
                    builder: (context, state) => const CalculatorDetailPage(
                      calculatorId: 'soil_composition_calculator',
                    ),
                  ),
                  GoRoute(
                    path: 'drainage',
                    ...
                    builder: (context, state) => const CalculatorDetailPage(
                      calculatorId: 'drainage_calculator',
                    ),
                  ),
                ],
              ),
...
class AppNavigation {
  ...
  static void toWeatherDetail(BuildContext context) =>
      context.push('/home/weather/detail');
...
class WeatherMeasurementsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Scaffold(
    ...
    body: const Center(
      child: Text('Weather Measurements Page - Em desenvolvimento'),
    ),
  );
}
...
class WeatherStatisticsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Scaffold(
    ...
    body: const Center(
      child: Text('Weather Statistics Page - Em desenvolvimento'),
    ),
  );
}
...
class SubscriptionPlansPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Scaffold(
    ...
    body: const Center(
      child: Text('Subscription Plans Page - Em desenvolvimento'),
    ),
  );
}
...
class PaymentMethodsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Scaffold(
    ...
    body: const Center(
      child: Text('Payment Methods Page - Em desenvolvimento'),
    ),
  );
}
