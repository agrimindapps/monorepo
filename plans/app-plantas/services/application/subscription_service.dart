...
class SubscriptionService extends GetxService {
  ...
  void onInit() {
    ...
    AuthService.instance.currentUserStream.listen((user) {
      if (user == null) {
  ...
  Future<bool> subscribe(SubscriptionPlan plan) async {
    try {
      ...
      final preco = plan == SubscriptionPlan.monthly ? 9.90 : 89.90;
      ...
      await AuthService.instance.updateUserPremiumStatus(true);
  ...
  void navegarParaPlanos() {
    // Navegar para a página premium usando o navigator
    PlantasNavigator.toPremium();
  }
