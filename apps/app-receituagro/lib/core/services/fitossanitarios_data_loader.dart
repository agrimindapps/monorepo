...
class FitossanitariosDataLoader {
  ...
  static Future<void> loadFitossanitariosData() async {
    if (_isLoaded) {
      developer.log('Fitossanitários já carregados, pulando...',
          name: 'FitossanitariosDataLoader');
      return;
    }

    try {
      developer.log('🛡️ [FITOSSANITARIOS] Iniciando carregamento de fitossanitários...',
          name: 'FitossanitariosDataLoader');
      print('🛡️ [FITOSSANITARIOS] Iniciando carregamento de fitossanitários...');
      ...
      developer.log('❌ [FITOSSANITARIOS] Erro durante carregamento de fitossanitários: $e',
          name: 'FitossanitariosDataLoader');
      print('❌ [FITOSSANITARIOS] Erro durante carregamento de fitossanitários: $e');
