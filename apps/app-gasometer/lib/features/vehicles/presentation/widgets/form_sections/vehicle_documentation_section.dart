        ...
        children: [
          Container(
            ...
            child: isReadOnly
                ? ReadOnlyField(
                    ...
                    value: odometerController.text.isEmpty
                        ? 'Não informado'
                        : '${NumberFormat('#,##0.00', 'pt_BR').format(double.tryParse(odometerController.text.replaceAll(',', '.')) ?? 0)} km',
                    icon: Icons.speed,
                  )
                : ValidatedFormField(
          ...
          Container(
            ...
            child: isReadOnly
                ? ReadOnlyField(
                    label: 'Placa',
                    value: plateController.text.isEmpty ? 'Não informado' : plateController.text,
          ...
          Container(
            ...
            child: isReadOnly
                ? ReadOnlyField(
                    label: 'Chassi',
                    value: chassisController.text.isEmpty ? 'Não informado' : chassisController.text,
                    icon: Icons.qr_code,
                  )
                : ValidatedFormField(
          ...
          Container(
            ...
            child: isReadOnly
                ? ReadOnlyField(
                    label: 'Renavam',
                    value: renavamController.text.isEmpty ? 'Não informado' : renavamController.text,
