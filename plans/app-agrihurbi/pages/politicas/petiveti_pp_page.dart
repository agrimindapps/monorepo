        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildParagraph(
                  'A Agrimind Apps construiu o aplicativo Raças & Espécies como um aplicativo suportado por anúncios. Este SERVIÇO é fornecido pela Agrimind Apps sem custo e destina-se ao uso como está.'),
              const SizedBox(height: 16),
              _buildParagraph(
              ...
              const SizedBox(height: 16),
              _buildParagraph(
                  'Os termos utilizados nesta Política de Privacidade têm os mesmos significados que em nossos Termos e Condições, que são acessíveis em Raças & Espécies, salvo definição em contrário nesta Política de Privacidade.'),
            ],
          ),
        ),
      ),
