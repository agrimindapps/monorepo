...
import 'DetalheDefensivos/presentation/widgets/comentarios_tab_widget.dart';
import 'DetalheDefensivos/presentation/widgets/custom_tab_bar_widget.dart';
import 'DetalheDefensivos/presentation/widgets/loading_error_widgets.dart';
import 'DetalheDefensivos/domain/entities/defensivo_details_entity.dart';

/// Página refatorada de detalhes do defensivo
/// Responsabilidade: coordenar widgets e providers
/// MENOS DE 300 LINHAS - Foco na composição
class DetalheDefensivoRefactoredPage extends StatefulWidget {
  final String defensivoName;
  final String fabricante;

  const DetalheDefensivoRefactoredPage({
    super.key,
  ...
  @override
  State<DetalheDefensivoRefactoredPage> createState() => _DetalheDefensivoRefactoredPageState();
}

class _DetalheDefensivoRefactoredPageState extends State<DetalheDefensivoRefactoredPage>
  ...
  Widget _buildInformacoesTab() {
    return Consumer<DetalheDefensivoProvider>(
      builder: (context, provider, child) {
        ...
        final entity = DefensivoDetailsEntity(
          id: provider.defensivoData!.idReg,
          nomeComum: provider.defensivoData!.nomeComum ?? '',
          nomeTecnico: provider.defensivoData!.nomeTecnico ?? '',
          fabricante: provider.defensivoData!.fabricante ?? '',
          ingredienteAtivo: provider.defensivoData!.ingredienteAtivo ?? '',
          toxico: provider.defensivoData!.toxico,
          inflamavel: provider.defensivoData!.inflamavel,
          corrosivo: provider.defensivoData!.corrosivo,
          modoAcao: provider.defensivoData!.modoAcao,
          classeAgronomica: provider.defensivoData!.classeAgronomica,
          classAmbiental: provider.defensivoData!.classAmbiental,
          formulacao: provider.defensivoData!.formulacao,
          idReg: provider.defensivoData!.idReg,
        );
