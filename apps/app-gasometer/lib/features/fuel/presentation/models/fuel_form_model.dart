...
class FuelFormModel extends Equatable {
  ...
  FuelRecordEntity toFuelRecord() {
    ...
    return FuelRecordEntity(
      ...
      odometer: odometer,
      date: date,
      gasStationName: gasStationName.isEmpty ? null : gasStationName,
      gasStationBrand: gasStationBrand.isEmpty ? null : gasStationBrand,
      fullTank: fullTank,
      notes: notes.isEmpty ? null : notes,
      photos: const [], // Por enquanto não suportamos fotos
