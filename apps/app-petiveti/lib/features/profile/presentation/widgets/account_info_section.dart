...
import 'package:core/core.dart' hide AuthState, AuthStatus, AuthProvider;
import 'package:flutter/material.dart';

import '../../../../core/theme/app_colors.dart';
import '../../../auth/domain/entities/user.dart' show AuthProvider;
import '../../../auth/presentation/providers/auth_provider.dart';

/// Seção de informações da conta do usuário
/// Inclui avatar editável, email, data de cadastro e ações
...
class _AccountInfoSectionState extends ConsumerState<AccountInfoSection> {
  ...
  Widget build(BuildContext context) {
    ...
    final user = authState.user;
    final isAnonymous = authState.status != AuthStatus.authenticated || user == null;

    if (user == null) {
      return const SizedBox.shrink();
    }

    final displayName = _sanitizeDisplayName(user.displayName, isAnonymous);
  ...
  String _sanitizeDisplayName(String? name, bool isAnonymous) {
    if (isAnonymous) return 'Visitante';
