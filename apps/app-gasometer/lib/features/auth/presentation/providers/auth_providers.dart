...
///
/// Estes providers são automáticamente atualizados quando o authProvider muda.
/// Use-os para acessar partes específicas do estado de autenticação de forma otimizada.
...
String syncMessage(Ref ref) {
  return ref.watch(authProvider).syncMessage;
}
