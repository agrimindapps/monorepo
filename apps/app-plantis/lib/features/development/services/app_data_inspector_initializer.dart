  ...
  static void initialize() {
    ...
    inspector.registerCustomBoxes([
      ...
      CustomBoxType(
        ...
        displayName: 'Plantas',
        module: 'plants',
        description: 'Dados completos das plantas cadastradas, incluindo informações básicas, cuidados e imagens',
      ),
      ...
      CustomBoxType(
        ...
        displayName: 'Espaços',
        module: 'spaces',
        description: 'Ambientes onde as plantas estão localizadas (sala, cozinha, varanda, etc)',
      ),
      ...
      CustomBoxType(
        ...
        module: 'tasks',
        description: 'Lembretes e tarefas de cuidados das plantas (regar, adubar, podar)',
      ),
      ...
      CustomBoxType(
        ...
        module: 'settings',
        description: 'Configurações gerais do aplicativo e preferências do usuário',
      ),
