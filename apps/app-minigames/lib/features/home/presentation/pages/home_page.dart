            ...
            return GridView.count(
              ...
              children: [
                ...
                _GameCard(
                  ...
                  icon: Icons.grid_on,
                  color: Colors.amber,
                  onTap: () => context.go('/2048'),
                ),
                _GameCard(
                  title: 'Flappy Bird',
                  icon: Icons.flight,
                  color: Colors.cyan,
                  onTap: () => context.go('/flappbird'),
                ),
                _GameCard(
                  title: 'Ping Pong',
                  icon: Icons.sports_tennis,
                  color: Colors.lime,
                  onTap: () => context.go('/pingpong'),
                ),
                _GameCard(
                  title: 'Quiz',
                  icon: Icons.quiz,
                ...
                _GameCard(
                  ...
                  onTap: () => context.go('/quiz-image'),
                ),
                _GameCard(
                  title: 'Caça Palavra',
                  icon: Icons.abc,
                  color: Colors.deepOrange,
                  onTap: () => context.go('/caca-palavra'),
                ),
                _GameCard(
                  title: 'Soletrando',
                  icon: Icons.spellcheck,
                  color: Colors.deepPurple,
                  onTap: () => context.go('/soletrando'),
                ),
              ],
            );
          },
