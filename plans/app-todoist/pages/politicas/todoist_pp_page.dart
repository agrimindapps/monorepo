...
class TodoistPoliticaPage extends StatefulWidget {
  const TodoistPoliticaPage({super.key});

  @override
  State<TodoistPoliticaPage> createState() => _TodoistPoliticaPageState();
}

class _TodoistPoliticaPageState extends State<TodoistPoliticaPage> {
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildParagraph(
                  'A Agrimind Apps construiu o aplicativo TodoApp como um aplicativo suportado por anúncios. Este SERVIÇO é fornecido pela Agrimind Apps sem custo e destina-se ao uso como está.'),
              const SizedBox(height: 16),
              _buildParagraph(
              ...
              const SizedBox(height: 16),
              _buildParagraph(
                  'Os termos utilizados nesta Política de Privacidade têm os mesmos significados que em nossos Termos e Condições, que são acessíveis no TodoApp, salvo definição em contrário nesta Política de Privacidade.'),
            ],
          ),
        ),
      ),
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 30),
              _buildParagraph(
                  'Para uma melhor experiência, ao usar nosso Serviço, podemos exigir que você nos forneça determinadas informações de identificação pessoal, incluindo, entre outras, suas tarefas, listas de afazeres, projetos, prazos, comentários, anexos e notas relacionadas à produtividade. As informações que solicitamos serão retidas no seu dispositivo e podem ser sincronizadas com nossos servidores para backup e sincronização entre dispositivos.'),
              const SizedBox(height: 16),
              _buildParagraph(
