...
class DinoRunSettingsPage extends ConsumerWidget {
  const DinoRunSettingsPage({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final settingsAsync = ref.watch(dinoRunSettingsProvider);

    return GamePageLayout(
      title: 'Configurações - DinoRun',
        ...
        data: (settings) => SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              _SectionTitle(title: 'Velocidade do Jogo'),
              Card(
                color: Colors.black.withValues(alpha: 0.3),
                child: Padding(
                  padding: const EdgeInsets.all(16),
                  child: Column(
                    children: DinoRunDifficulty.values.map((difficulty) {
                      return RadioListTile<DinoRunDifficulty>(
  ...
  void _updateSettings(WidgetRef ref, DinoRunSettings settings) {
    final updater = ref.read(dinoRunSettingsUpdaterProvider.notifier);
