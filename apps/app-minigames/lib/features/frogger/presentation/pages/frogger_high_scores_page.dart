...
class FroggerHighScoresPage extends ConsumerWidget {
  const FroggerHighScoresPage({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final scoresAsync = ref.watch(froggerHighScoresProvider);
    final statsAsync = ref.watch(froggerStatsProvider);

    return GamePageLayout(
      title: 'High Scores - Frogger',
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      _StatItem(label: 'Nível Máximo', value: '${stats.highestLevel}'),
                    ],
                  ),
                ),
              ),
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Card(
                        ...
                        child: ListTile(
                          ...
                          subtitle: Text(
                            'Nível ${score.level} • ${score.crossingsCompleted} tijolos • ${score.level}',
                            style: TextStyle(color: Colors.white.withValues(alpha: 0.6), fontSize: 12),
                          ),
                          trailing: IconButton(
                            icon: Icon(Icons.delete_outline, color: Colors.white.withValues(alpha: 0.5)),
                            onPressed: () async {
                              final deleter = ref.read(froggerScoreDeleterProvider.notifier);
