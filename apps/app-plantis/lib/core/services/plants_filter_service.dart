...
class PlantsFilterService {
  ...
  List<Plant> filterBySearchTerm(List<Plant> plants, String searchTerm) {
    ...
    return plants.where((plant) {
      ...
      final speciesMatches =
          plant.species?.toLowerCase().contains(lowerSearchTerm) ?? false;
      final notesMatches =
          plant.notes?.toLowerCase().contains(lowerSearchTerm) ?? false;
  ...
  List<Plant> filterByCareStatus(List<Plant> plants, PlantCareStatus status) {
    return plants
        .where((plant) => _getPlantCareStatus(plant) == status)
        .toList();
  }
