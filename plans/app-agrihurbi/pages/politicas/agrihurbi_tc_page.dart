...
class AgrihurbiTermosPage extends StatefulWidget {
  const AgrihurbiTermosPage({super.key});

  @override
  State<AgrihurbiTermosPage> createState() => _AgrihurbiTermosPageState();
}

class _AgrihurbiTermosPageState extends State<AgrihurbiTermosPage> {
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              _buildParagraph(
                  'O aplicativo CalcAgro armazena e processa dados pessoais que você nos forneceu, para fornecer meu Serviço. É sua responsabilidade manter seu telefone e o acesso ao aplicativo seguros. Portanto, recomendamos que você não faça o jailbreak ou root no seu telefone, que é o processo de remoção de restrições e limitações de software impostas pelo sistema operacional oficial do seu dispositivo. Isso pode tornar seu telefone vulnerável a malware/vírus/programas maliciosos, comprometer os recursos de segurança do seu telefone e pode significar que o aplicativo CalcAgro não funcionará corretamente ou não funcionará.'),
            ],
          ),
        ),
      ),
