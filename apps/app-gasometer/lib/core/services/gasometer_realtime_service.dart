...
/// Serviço para gerenciar sincronização em tempo real do Gasometer
/// com otimizações de performance e bateria
///
/// Baseado no ReceitaAgroRealtimeService
class GasometerRealtimeService with WidgetsBindingObserver {
  GasometerRealtimeService({
  ...
  Future<void> initialize() async {
    ...
    try {
      ...
      _isInitialized = true;
      developer.log(
        'GasometerRealtimeService inicializado',
        name: 'RealtimeService',
      );
    } catch (e) {
      developer.log(
        'Erro ao inicializar GasometerRealtimeService: $e',
        name: 'RealtimeService',
      );
    }
  }
  ...
  Future<void> dispose() async {
    try {
      ...
      developer.log('GasometerRealtimeService disposed', name: 'RealtimeService');
    } catch (e) {
      developer.log(
        'Erro ao fazer dispose do GasometerRealtimeService: $e',
        name: 'RealtimeService',
      );
    }
  }
