...
/// Inspirada na estrutura do app-gasometer com design adaptado para plantas
class PromotionalPageNew extends ConsumerStatefulWidget {
  const PromotionalPageNew({super.key});

  @override
  ConsumerState<PromotionalPageNew> createState() => _PromotionalPageNewState();
}

class _PromotionalPageNewState extends ConsumerState<PromotionalPageNew> {
