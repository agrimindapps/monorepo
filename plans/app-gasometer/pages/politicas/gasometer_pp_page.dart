...
class GasOMeterPoliticaPage extends StatefulWidget {
  const GasOMeterPoliticaPage({super.key});

  @override
  State<GasOMeterPoliticaPage> createState() => _GasOMeterPoliticaPageState();
}

class _GasOMeterPoliticaPageState extends State<GasOMeterPoliticaPage> {
