...
part 'subscription_provider_migrated.g.dart';
...
class Subscription extends _$Subscription {
  late final GetAvailablePlans _getAvailablePlans;
  late final GetCurrentSubscription _getCurrentSubscription;
  late final SubscribeToPlan _subscribeToPlan;
  late final CancelSubscription _cancelSubscription;
  late final PauseSubscription _pauseSubscription;
  late final ResumeSubscription _resumeSubscription;
  late final UpgradePlan _upgradePlan;
  late final RestorePurchases _restorePurchases;

  @override
  SubscriptionState build() {
    _getAvailablePlans = ref.watch(getAvailablePlansProvider);
    _getCurrentSubscription = ref.watch(getCurrentSubscriptionProvider);
    _subscribeToPlan = ref.watch(subscribeToPlanProvider);
    _cancelSubscription = ref.watch(cancelSubscriptionProvider);
    _pauseSubscription = ref.watch(pauseSubscriptionProvider);
    _resumeSubscription = ref.watch(resumeSubscriptionProvider);
    _upgradePlan = ref.watch(upgradePlanProvider);
    _restorePurchases = ref.watch(restorePurchasesProvider);
