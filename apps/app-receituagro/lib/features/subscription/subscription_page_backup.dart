// BACKUP DA VERSÃO ORIGINAL - subscription_page.dart
// Data do backup: 2025-08-31
// Motivo: Refatoração para Clean Architecture seguindo padrão estabelecido
...
class SubscriptionPageBackup extends StatefulWidget {
  const SubscriptionPageBackup({super.key});

  @override
  State<SubscriptionPageBackup> createState() => _SubscriptionPageBackupState();
}

class _SubscriptionPageBackupState extends State<SubscriptionPageBackup> {
  ...
  // Método removido: _buildSubscriptionPlansView - não utilizado na implementação
