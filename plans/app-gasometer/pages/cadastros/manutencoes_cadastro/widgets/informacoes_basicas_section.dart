...
class InformacoesBasicasSectionWidget extends StatelessWidget {
  final ManutencoesCadastroFormController controller;

  const InformacoesBasicasSectionWidget({
    super.key,
    ...
    return Container(
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [
            ShadcnStyle.primaryColor.withValues(alpha: 0.03),
            Colors.transparent,
          ],
            ...
            Container(
              ...
              child: Row(
                children: [
                  ...
                  Text(
                    ManutencaoConstants.fieldLabels['dataHora']!,
                    style: TextStyle(
                      fontSize: 13,
                      fontWeight: FontWeight.w600,
                      color: ShadcnStyle.primaryColor,
