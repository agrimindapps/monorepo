...
class _TaskListDetailPageState extends ConsumerState<TaskListDetailPage> {
  ...
  BoxDecoration? _getBackgroundDecoration() {
    final bg = widget.taskList.backgroundImage;
  ...
  Widget build(BuildContext context) {
    ...
    final bgDecoration = _getBackgroundDecoration();

    return Scaffold(
      extendBodyBehindAppBar: bgDecoration != null,
      appBar: AppBar(
        title: Text(widget.taskList.title),
        elevation: 0,
        backgroundColor: bgDecoration != null ? Colors.transparent : color.withValues(alpha: 0.1),
        foregroundColor: bgDecoration != null ? Colors.white : color,
        actions: [
          PopupMenuButton(
      ...
      body: Container(
        ...
        child: Column(
          children: [
            if (bgDecoration != null)
              SizedBox(height: kToolbarHeight + MediaQuery.of(context).padding.top),
            // Header com informações da lista
            Container(
              width: double.infinity,
              decoration: BoxDecoration(
                color: bgDecoration != null ? Colors.black26 : color.withValues(alpha: 0.1),
                border: Border(
                  bottom: BorderSide(
                    color: bgDecoration != null ? Colors.white24 : color.withValues(alpha: 0.3),
                    width: 2,
                  ),
                ),
              ),
                ...
                children: [
                  if (widget.taskList.description?.isNotEmpty ?? false) ...[
                    Text(
                      ...
                      style: Theme.of(
                        ...
                        color: bgDecoration != null ? Colors.white : color
                      ),
                    ),
                  ...
                  tasksAsync.when(
                    data: (allTasks) {
                      ...
                      return Row(
                        children: [
                          Icon(Icons.task_alt, size: 18, color: bgDecoration != null ? Colors.white : color),
                          ...
                          if (widget.taskList.isShared) ...[
                            ...
                            Icon(Icons.people_outline, size: 18, color: bgDecoration != null ? Colors.white : color),
                            const SizedBox(width: 8),
                            Text(
                ...
                data: (allTasks) {
                  ...
                  if (tasks.isEmpty) {
                    return EmptyStateWidget(
                      ...
                      textColor: bgDecoration != null ? Colors.white : null,
                    );
                  }
