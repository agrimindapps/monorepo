...
class PesoFormWidget extends StatefulWidget {
  ...
  @override
  State<PesoFormWidget> createState() => _PesoFormWidgetState();
}

class _PesoFormWidgetState extends State<PesoFormWidget> {
  final _formKey = GlobalKey<FormState>();
  late PesoModel _localRegistro;
  final _pesoController = TextEditingController();
  final _dataController = TextEditingController();
  final _repository = PesoRepository();
    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        if (widget.registro != null) {
          _repository.updated(_localRegistro);
          Get.snackbar(
            'Sucesso',
          ...
          _repository.add(_localRegistro);
          Get.snackbar(
            'Sucesso',
        ...
        Get.snackbar(
          'Erro',
          'Ocorreu um erro ao salvar os dados: ${e.toString()}',
          snackPosition: SnackPosition.BOTTOM,
