...
class ConnectFourHighScoresPage extends ConsumerWidget {
  const ConnectFourHighScoresPage({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final scoresAsync = ref.watch(connect_fourHighScoresProvider);
    final statsAsync = ref.watch(connect_fourStatsProvider);

    return GamePageLayout(
      title: 'High Scores - ConnectFour',
