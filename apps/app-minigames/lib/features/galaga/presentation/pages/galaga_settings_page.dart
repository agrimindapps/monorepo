...
class GalagaSettingsPage extends ConsumerWidget {
  const GalagaSettingsPage({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final settingsAsync = ref.watch(galagaSettingsProvider);

    return GamePageLayout(
      title: 'Configurações - Galaga',
            ...
            children: [
              ...
              Card(
                ...
                child: Padding(
                  padding: const EdgeInsets.all(16),
                  child: Column(
                    children: GalagaDifficulty.values.map((difficulty) {
                      return RadioListTile<GalagaDifficulty>(
  ...
  void _updateSettings(WidgetRef ref, GalagaSettings settings) {
    final updater = ref.read(galagaSettingsUpdaterProvider.notifier);
