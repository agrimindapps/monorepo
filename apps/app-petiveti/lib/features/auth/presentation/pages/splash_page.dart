                ...
                child: ScaleTransition(
                  ...
                  child: Column(
                    ...
                    children: [
                          ...
                          decoration: BoxDecoration(
                            ...
                            boxShadow: [
                              BoxShadow(
                                ...
                                blurRadius:
                                    SplashConstants.logoShadowBlurRadius,
                      ...
                      const SizedBox(
                        height: SplashConstants.logoToTitleSpacing,
                      ),
                      Semantics(
                      ...
                      const SizedBox(
                        height: SplashConstants.titleToTaglineSpacing,
                      ),
                      Semantics(
                        label:
                            'Slogan do aplicativo: ${SplashConstants.appTagline}',
                        child: Text(
                      ...
                      const SizedBox(
                        height: SplashConstants.taglineToIndicatorSpacing,
                      ),
                      Semantics(
                        label: 'Carregando aplicativo',
                        hint:
                            'Aguarde enquanto o PetiVeti está sendo inicializado',
                        liveRegion: true,
                        child: SizedBox(
                          ...
                          child: CircularProgressIndicator(
                            strokeWidth:
                                SplashConstants.progressIndicatorStrokeWidth,
                            valueColor: AlwaysStoppedAnimation<Color>(
                              SplashColors.getProgressIndicatorColor(context),
                            ),
                          ),
                        ),
                      ),
