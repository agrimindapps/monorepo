...
class AsteroidsSettingsPage extends ConsumerWidget {
  const AsteroidsSettingsPage({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final settingsAsync = ref.watch(asteroidsSettingsProvider);

    return GamePageLayout(
      title: 'Configurações - Asteroids',
            ...
            children: [
              ...
              Card(
                ...
                child: Padding(
                  padding: const EdgeInsets.all(16),
                  child: Column(
                    children: AsteroidsDifficulty.values.map((difficulty) {
                      return RadioListTile<AsteroidsDifficulty>(
  ...
  void _updateSettings(WidgetRef ref, AsteroidsSettings settings) {
    final updater = ref.read(asteroidsSettingsUpdaterProvider.notifier);
