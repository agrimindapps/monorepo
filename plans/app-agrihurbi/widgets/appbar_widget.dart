            ...
            child: Row(
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: isDark
                        ? AgrihurbiTheme.agriculturaPrimary.withValues(alpha: 0.15)
                        : AgrihurbiTheme.agriculturaSurface,
                    shape: BoxShape.circle,
                    border: Border.all(
                      color: AgrihurbiTheme.agriculturaAccent,
                      width: 2,
                    ),
                  ),
                  child: Icon(
                    icon,
                    size: isMobile ? 16 : 18,
                    color: AgrihurbiTheme.agriculturaSecondary,
                  ),
                ),
