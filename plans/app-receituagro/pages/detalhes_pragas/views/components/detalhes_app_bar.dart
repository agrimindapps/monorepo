...
/// AppBar customizada específica para a página de detalhes de pragas
class PragaDetalhesAppBar extends StatelessWidget {
  final String title;
      ...
      children: [
        ...
        if (subtitle.isNotEmpty)
          Text(
            subtitle,
            style: TextStyle(
              color: _getSubtitleColor(context, isDark),
              fontSize: 14,
            ),
            maxLines: 1,
            overflow: TextOverflow.ellipsis,
  ...
  // Helper methods to match DetalhesDefensivosDesignTokens pattern
  ...
  Color _getPrimaryLightColor() {
    return const Color(0xFF2E7D32).withValues(alpha: 0.1);
  }

  List<BoxShadow> _getSubtleShadow() {
    return [
      BoxShadow(
  ...
  List<BoxShadow> _getCardShadow(Color color) {
    return [
      BoxShadow(
