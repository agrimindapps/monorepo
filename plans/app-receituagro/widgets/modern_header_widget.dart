...
class ModernHeaderWidget extends StatelessWidget {
  ...
  const ModernHeaderWidget({
    ...
    this.onBackPressed,
    this.showBackButton = false, // Para home pages, default é false
    this.showActions = false, // Por padrão não mostra ações
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          // Área de ações (só aparece se showActions for true)
          if (showActions) ...[
            const SizedBox(width: 13),

            // Ações adicionais (se existirem)
