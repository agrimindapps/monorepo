...
// Project imports:
import '../politicas/todoist_pp_page.dart';
import '../politicas/todoist_tc_page.dart';

class TodoistFooterSection extends StatelessWidget {
  const TodoistFooterSection({super.key});
        ...
        children: [
          ...
          Row(
            ...
            children: [
              _buildPolicyLink(
                ...
                () => Get.to(() => const TodoistPoliticaPage()),
              ),
              ...
              _buildPolicyLink(
                'Termos de Uso',
                () => Get.to(() => const TodoistTermosPage()),
              ),
            ],
          ),
          ...
          Row(
            ...
            children: [
              Expanded(
                child: Text(
                  '© ${DateTime.now().year} Todoist. Todos os direitos reservados.',
