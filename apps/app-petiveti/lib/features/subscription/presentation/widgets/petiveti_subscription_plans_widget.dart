...
/// Widget responsável pela exibição e seleção de planos de subscription para PetiVeti
///
/// Design inspirado no Plantis com cores roxas do PetiVeti
class PetivetiSubscriptionPlansWidget extends StatefulWidget {
  final List<ProductInfo> availableProducts;
  final String? selectedPlanId;
  final void Function(String) onPlanSelected;

  const PetivetiSubscriptionPlansWidget({
    super.key,
  ...
  @override
  State<PetivetiSubscriptionPlansWidget> createState() =>
      _PetivetiSubscriptionPlansWidgetState();
}

class _PetivetiSubscriptionPlansWidgetState
    extends State<PetivetiSubscriptionPlansWidget> {
  ...
  @override
  void didUpdateWidget(PetivetiSubscriptionPlansWidget oldWidget) {
  ...
  List<ProductInfo> _getMockProducts() {
    return [
      ...
      const ProductInfo(
        productId: 'petiveti_premium_semester',
        title: 'Semestral',
      ...
      const ProductInfo(
        productId: 'petiveti_premium_annual',
        title: 'Anual',
  ...
  Widget _buildPlanCard({
    ...
    // Dynamic colors based on selection and hero status - using PetiVeti colors
    final borderColor = isSelected
        ? (isHero
              ? const Color(0xFFFFD700) // Gold for hero
              : Colors.white.withValues(alpha: 0.6))
        : Colors.white.withValues(alpha: 0.1);

    final backgroundColor = isSelected
        ? (isHero
              ? const Color(0x33FFD700) // Gold tint for hero
