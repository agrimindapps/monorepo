...
class _SubscriptionPlansWidgetState extends State<SubscriptionPlansWidget> {
  ...
  List<ProductInfo> _getMockProducts() {
    return [
      const ProductInfo(
        productId: 'nebulalist_premium_monthly',
        title: 'Mensal',
      ...
      const ProductInfo(
        productId: 'nebulalist_premium_semester',
        title: 'Semestral',
      ...
      const ProductInfo(
        productId: 'nebulalist_premium_annual',
        title: 'Anual',
  ...
  Widget _buildPlanOption(ProductInfo product) {
    ...
    if (isYearly) {
      ...
      planTitle = 'Mensal';
      planSubtitle = 'Flexibilidade total';
    } else if (isWeekly) {
      planTitle = 'Semanal';
    } else {
  ...
  Widget _buildPlanCard({
    ...
    // Dynamic colors based on selection and hero status - Nebula theme
    final borderColor = isSelected
        ? (isHero
              ? NebulaColors.accentCyan
              : NebulaColors.primaryPurple.withValues(alpha: 0.6))
        : Colors.white.withValues(alpha: 0.1);

    final backgroundColor = isSelected
        ? (isHero
              ? NebulaColors.accentCyan.withValues(alpha: 0.15)
              : NebulaColors.primaryPurple.withValues(alpha: 0.15))
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(
                        color: NebulaColors.accentCyan.withValues(alpha: 0.4),
                        blurRadius: 8,
