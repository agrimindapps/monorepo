...
class VersionManagerService implements IVersionManager {
  ...
  Future<String> getCurrentVersionAsync() async {
    try {
      ...
      developer.log(
        'Erro ao obter versão via PackageInfo: $e',
        name: 'VersionManagerService',
      );
  ...
  bool needsUpdate(String storedVersion, String currentVersion) {
    if (storedVersion.isEmpty) {
      developer.log(
        'Primeira execução - dados precisam ser carregados',
        name: 'VersionManagerService',
      );
      return true;
    }
  ...
  Future<void> markAsUpdated(String version, String boxName) async {
    try {
      ...
      developer.log(
        'Versão $version marcada como atualizada para $boxName',
        name: 'VersionManagerService',
      );
    } catch (e) {
      developer.log(
        'Erro ao marcar versão como atualizada: $e',
        name: 'VersionManagerService',
      );
    }
  }
  ...
  Future<String> getStoredVersion(String boxName) async {
    try {
      ...
      developer.log(
        'Erro ao obter versão armazenada para $boxName: $e',
        name: 'VersionManagerService',
      );
      return '';
    }
  ...
  Future<String> getLastDataVersion() async {
    try {
      ...
      developer.log(
        'Erro ao obter última versão de dados: $e',
        name: 'VersionManagerService',
      );
      return '';
    }
  ...
  Future<void> clearVersionInfo() async {
    try {
      ...
      developer.log(
        'Informações de versão limpas',
        name: 'VersionManagerService',
      );
    } catch (e) {
      developer.log(
        'Erro ao limpar informações de versão: $e',
        name: 'VersionManagerService',
      );
    }
  }
  ...
  Future<Map<String, String>> getVersionStats() async {
    try {
      ...
      developer.log(
        'Erro ao obter estatísticas de versão: $e',
        name: 'VersionManagerService',
      );
      return {};
    }
  ...
  Future<Box<String>> _getVersionBox() async {
    try {
      ...
      developer.log(
        'Erro ao abrir box de versões: $e',
        name: 'VersionManagerService',
      );
      rethrow;
    }
  ...
  Future<bool> detectVersionChange() async {
    try {
      ...
      developer.log(
        'Erro ao detectar mudança de versão: $e',
        name: 'VersionManagerService',
      );
  ...
  Future<String> getLastSavedAppVersion() async {
    try {
      ...
      developer.log(
        'Erro ao obter última versão salva: $e',
        name: 'VersionManagerService',
      );
      return '';
    }
  ...
  Future<void> saveCurrentAppVersion() async {
    try {
      ...
      developer.log(
        'Versão atual salva: $currentVersion',
        name: 'VersionManagerService',
      );
    } catch (e) {
      developer.log(
        'Erro ao salvar versão atual: $e',
        name: 'VersionManagerService',
      );
    }
  }
  ...
  Future<void> completeVersionUpdate() async {
    try {
      ...
      developer.log(
        'Atualização de versão concluída. Stats: $stats',
        name: 'VersionManagerService',
      );
    } catch (e) {
      developer.log(
        'Erro ao completar atualização de versão: $e',
        name: 'VersionManagerService',
      );
    }
  }
  ...
  Future<bool> verifyVersionIntegrity() async {
    try {
      ...
      final lastData =
          versionBox.get(_lastDataVersionKey, defaultValue: '') ?? '';
      ...
      developer.log(
        'Erro na verificação de integridade: $e',
        name: 'VersionManagerService',
      );
      return false;
    }
