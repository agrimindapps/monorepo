...
/// Controller padronizado para autenticação do módulo PetiVeti
class PetivetiAuthController extends ChangeNotifier {
  ...
  static const ModuleAuthConfig _moduleConfig = ModuleAuthConfig.petiveti;
  ...
  String? validateEmail(String? value) {
    return _validationService.validateEmailForModule(value, _moduleConfig.moduleName);
  }
  ...
  String? validateConfirmPassword(String? value) {
    return _validationService.validateConfirmPassword(value, passwordController.text);
  }
    ...
    try {
      ...
      if (result.success && result.user != null) {
        _showSuccessMessage('Conta criada com sucesso!', 
            'Bem-vindo ao PetiVeti, ${nameController.text}');
