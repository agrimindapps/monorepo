...
/// Model específico do app-petiveti para dispositivos
...
class DeviceModel extends DeviceEntity {
  const DeviceModel({
    ...
    super.createdAt,
    super.updatedAt,
    this.petivetiSpecificData,
  });

  /// Dados específicos do app-petiveti (extensão futura)
  final Map<String, dynamic>? petivetiSpecificData;
  ...
  factory DeviceModel.fromJson(Map<String, dynamic> json) {
    ...
    return DeviceModel(
      ...
      petivetiSpecificData: json['petivetiSpecificData'] as Map<String, dynamic>?,
    );
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (petivetiSpecificData != null) {
      json['petivetiSpecificData'] = petivetiSpecificData;
    }
    return json;
  }
  ...
  DeviceModel copyWith({
    ...
    DateTime? createdAt,
    DateTime? updatedAt,
    Map<String, dynamic>? petivetiSpecificData,
  }) {
    return DeviceModel(
      id: id ?? this.id,
      uuid: uuid ?? this.uuid,
      ...
      petivetiSpecificData: petivetiSpecificData ?? this.petivetiSpecificData,
    );
  }

  /// Retorna ícone específico para a plataforma no app-petiveti
  ...
  /// Retorna status visual para UI do petiveti
  ...
  /// Retorna cor do status para o tema do petiveti
  ...
  @override
  List<Object?> get props => [...super.props, petivetiSpecificData];
}

/// Model para estatísticas de dispositivos específicas do petiveti
class DeviceStatisticsModel extends DeviceStatistics {
  const DeviceStatisticsModel({
    ...
    super.oldestDevice,
    super.newestDevice,
    this.petivetiMetrics,
  });

  /// Métricas específicas do app-petiveti
  final Map<String, dynamic>? petivetiMetrics;
  ...
  /// Retorna resumo formatado para UI do petiveti
  String get summary {
