...
class ArkanoidHighScoresPage extends ConsumerWidget {
  const ArkanoidHighScoresPage({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final scoresAsync = ref.watch(arkanoidHighScoresProvider);
    final statsAsync = ref.watch(arkanoidStatsProvider);

    return GamePageLayout(
      title: 'High Scores - Arkanoid',
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      _StatItem(label: 'Tijolos', value: '${stats.totalBricksDestroyed}'),
                      _StatItem(label: 'Level Máximo', value: '${stats.highestLevel}'),
                    ],
                  ),
                ),
              ),
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Card(
                        ...
                        child: ListTile(
                          ...
                          subtitle: Text(
                            'Level ${score.level} • ${score.bricksDestroyed} tijolos • ${score.formattedDuration}',
                            style: TextStyle(color: Colors.white.withValues(alpha: 0.6), fontSize: 12),
                          ),
                          trailing: IconButton(
                            icon: Icon(Icons.delete_outline, color: Colors.white.withValues(alpha: 0.5)),
                            onPressed: () async {
                              final deleter = ref.read(arkanoidScoreDeleterProvider.notifier);
