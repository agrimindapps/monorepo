...
class NotificationsUsageExample {
  ...
  static Future<void> initializeNotifications() async {
    ...
    if (success) {
      ...
      print('❌ Falha na inicialização das notificações');
    }
  }
  ...
  static Future<void> scheduleNewTaskNotification() async {
    ...
    print('📅 Notificação de tarefa agendada para 3 dias');
  }
  ...
  static Future<void> notifyNewPlantAdded() async {
    ...
    print('🌱 Notificação de nova planta enviada');
  }
  ...
  static Future<void> checkAndRequestPermissions() async {
    ...
    if (!hasPermission) {
      ...
      if (granted) {
        ...
        print('❌ Permissão negada - mostrando opção para abrir configurações');
  ...
  static Future<void> cancelTaskNotifications() async {
    ...
    print('🚫 Notificações da tarefa canceladas');
  }
  ...
  static Future<void> checkOverdueTasksPeriodically() async {
    ...
    print('🔍 Verificação de tarefas atrasadas executada');
  }
  ...
  static Future<void> setupDailyReminders() async {
    ...
    print('📅 Lembretes diários configurados');
  }
  ...
  static Future<void> integrateWithTaskProvider() async {
    ...
    print('🔗 Notificação integrada com provider de tarefas');
  }
  ...
  static Future<void> advancedNotificationManagement() async {
    ...
    final isScheduled = await notificationManager.isNotificationScheduled('task_123');
    print('📋 Tarefa 123 tem notificação agendada: $isScheduled');
