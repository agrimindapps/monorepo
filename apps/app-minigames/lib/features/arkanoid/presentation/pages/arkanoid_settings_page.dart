...
class ArkanoidSettingsPage extends ConsumerWidget {
  const ArkanoidSettingsPage({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final settingsAsync = ref.watch(arkanoidSettingsProvider);

    return GamePageLayout(
      title: 'Configurações - Arkanoid',
            ...
            children: [
              ...
              Card(
                ...
                child: Padding(
                  padding: const EdgeInsets.all(16),
                  child: Column(
                    children: ArkanoidDifficulty.values.map((difficulty) {
                      return RadioListTile<ArkanoidDifficulty>(
  ...
  void _updateSettings(WidgetRef ref, ArkanoidSettings settings) {
    final updater = ref.read(arkanoidSettingsUpdaterProvider.notifier);
