...
class NutriTutiPoliticaPage extends StatefulWidget {
  const NutriTutiPoliticaPage({super.key});

  @override
  State<NutriTutiPoliticaPage> createState() => _NutriTutiPoliticaPageState();
}

class _NutriTutiPoliticaPageState extends State<NutriTutiPoliticaPage> {
  // Inicializamos o ScrollController no initState em vez de diretamente no campo
  ...
  void initState() {
    super.initState();
    // Inicializar o controller no initState
    scrollController = ScrollController();
  }

  @override
  void dispose() {
    // Certificar-se de descartar o controller adequadamente
    scrollController.dispose();
    super.dispose();
  }

  // Modificamos o método para não usar Scrollable.ensureVisible diretamente
  // e em vez disso usar o scrollController de forma mais segura
  void _scrollToSection(GlobalKey key) {
    final context = key.currentContext;
    if (context != null) {
      // Verificamos se o scrollController está anexado antes de tentar usá-lo
      if (scrollController.hasClients) {
        ...
        // Se o controller ainda não estiver anexado, usamos o Scrollable.ensureVisible
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildParagraph(
                  'A Agrimind Apps construiu o aplicativo NutriTuti como um aplicativo suportado por anúncios. Este SERVIÇO é fornecido pela Agrimind Apps sem custo e destina-se ao uso como está.'),
              const SizedBox(height: 16),
              _buildParagraph(
              ...
              const SizedBox(height: 16),
              _buildParagraph(
                  'Os termos utilizados nesta Política de Privacidade têm os mesmos significados que em nossos Termos e Condições, que são acessíveis em NutriTuti, salvo definição em contrário nesta Política de Privacidade.'),
            ],
          ),
        ),
      ),
