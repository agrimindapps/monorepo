...
class _DetalheDiagnosticoPageState extends State<DetalheDiagnosticoPage> with TickerProviderStateMixin {
                                    ...
                                    Expanded(
                                      child: TabBarView(
                                        ...
                                        children: [
                                          _buildImageContent(),
                                          _buildInfoContent(),
                                          _buildDiagnosticoContent(),
                                          _buildAplicacaoContent(),
                                        ],
                                      ),
                                    ),
                                  ],
  ...
  Widget _buildDiagnosticoContent() {
    return SingleChildScrollView(
      padding: const EdgeInsets.all(16),
      child: Column(
        children: [
