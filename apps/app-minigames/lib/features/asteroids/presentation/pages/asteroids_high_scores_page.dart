...
class AsteroidsHighScoresPage extends ConsumerWidget {
  const AsteroidsHighScoresPage({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final scoresAsync = ref.watch(asteroidsHighScoresProvider);
    final statsAsync = ref.watch(asteroidsStatsProvider);

    return GamePageLayout(
      title: 'High Scores - Asteroids',
                ...
                child: Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      _StatItem(label: 'Tijolos', value: '${stats.totalAsteroidsDestroyed}'),
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Card(
                        ...
                        child: ListTile(
                          ...
                          subtitle: Text(
                            'Wave ${score.wave} • ${score.asteroidsDestroyed} tijolos • ${score.wave}',
                            style: TextStyle(color: Colors.white.withValues(alpha: 0.6), fontSize: 12),
                          ),
                          trailing: IconButton(
                            icon: Icon(Icons.delete_outline, color: Colors.white.withValues(alpha: 0.5)),
                            onPressed: () async {
                              final deleter = ref.read(asteroidsScoreDeleterProvider.notifier);
