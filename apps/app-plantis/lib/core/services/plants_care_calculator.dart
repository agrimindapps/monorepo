...
class PlantCareStatistics {
  ...
  double get healthyPercentage =>
      totalPlants > 0 ? (healthyPlants / totalPlants) * 100 : 0;
  double get needsWaterPercentage =>
      totalPlants > 0 ? (plantsNeedingWater / totalPlants) * 100 : 0;
  double get criticalPercentage =>
      totalPlants > 0 ? (criticalPlants / totalPlants) * 100 : 0;
}
