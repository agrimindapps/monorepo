...
class PatinamentoNWidget extends StatelessWidget {
  final MaquinarioController controller;
  final int index;

  const PatinamentoNWidget({
    super.key,
            ...
            child: Column(
              ...
              children: [
                VTextField(
                  ...
                  labelText: 'Número de Voltas com Implemento levantado',
                  keyboardType:
                ...
                VTextField(
                  ...
                  labelText: 'Número de Voltas com Implemento baixado',
                  keyboardType:
                      const TextInputType.numberWithOptions(decimal: true),
                  onChanged: (value) {
