...
class HiveAdapterRegistry {
  ...
  static const Map<String, String> boxNames = {
    ...
    'diagnosticos_static': 'receituagro_diagnosticos_static',
  ...
  static Future<void> openBoxes() async {
    try {
      await Future.wait([
        ...
        Hive.openBox<DiagnosticoHive>(boxNames['diagnosticos_static']!),
  ...
  static Future<void> closeBoxes() async {
    try {
      await Future.wait([
        ...
        _closeBoxIfOpen(boxNames['diagnosticos_static']!),
