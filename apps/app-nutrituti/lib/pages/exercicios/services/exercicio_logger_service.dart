...
/// Professional logging service for exercise module
class ExercicioLoggerService {
  static final ExercicioLoggerService _instance = ExercicioLoggerService._internal();
  factory ExercicioLoggerService() => _instance;
  ExercicioLoggerService._internal();

  static const String _component = 'Exercicio';
  ...
  // ========================================================================
  // SPECIALIZED LOGGING METHODS FOR EXERCISE MODULE
  // ========================================================================

  /// Log exercise operation (create, update, delete)
  void logExerciseOperation(String operation, {
    String? exerciseId,
    String? exerciseName,
    bool success = true,
    Object? error,
    ...
    if (exerciseId != null) context['exerciseId'] = exerciseId;
    if (exerciseName != null) context['exerciseName'] = exerciseName;
    
    if (success) {
      info('Exercise operation completed: $operation', 
           component: 'ExerciseOps', context: context);
    } else {
      this.error('Exercise operation failed: $operation', 
            component: 'ExerciseOps', context: context, error: error);
    }
  }

  /// Log validation errors
  void logValidationError(String field, String message, {
    dynamic value,
    String? exerciseId,
  }) {
    final context = <String, dynamic>{
    ...
    if (value != null) context['value'] = value.toString();
    if (exerciseId != null) context['exerciseId'] = exerciseId;
    
    warning('Validation error in field: $field', 
            component: 'Validation', context: context);
  }
  ...
  void logPerformance(String operation, Duration duration, {
    ...
    if (duration.inMilliseconds > ExercicioConstants.slowOperationThresholdMs) {
  ...
  void logNetworkOperation(String operation, {
    String? endpoint,
    int? statusCode,
    bool success = true,
    Object? error,
    ...
    if (endpoint != null) context['endpoint'] = endpoint;
    if (statusCode != null) context['statusCode'] = statusCode;
    if (duration != null) context['durationMs'] = duration.inMilliseconds;
    
    if (success) {
      info('Network operation: $operation', 
           component: 'Network', context: context);
    } else {
      this.error('Network operation failed: $operation', 
            component: 'Network', context: context, error: error);
    }
  }

  /// Log cache operations
  void logCacheOperation(String operation, {
    String? key,
    bool hit = false,
    int? size,
  }) {
    ...
    if (operation == 'get') context['hit'] = hit;
    if (size != null) context['size'] = size;
    
    debug('Cache operation: $operation', 
          component: 'Cache', context: context);
  }
  ...
  void _log(LogLevel level, String message, {
    ...
    if (_recentLogs.length > ExercicioConstants.maxRecentLogs) {
  ...
  int _getDevLogLevel(LogLevel level) {
    switch (level) {
      case LogLevel.verbose:
        return ExercicioConstants.logLevelVerbose;
      case LogLevel.debug:
        return ExercicioConstants.logLevelDebug;
      case LogLevel.info:
        return ExercicioConstants.logLevelInfo;
      case LogLevel.warning:
        return ExercicioConstants.logLevelWarning;
      case LogLevel.error:
        return ExercicioConstants.logLevelError;
      case LogLevel.fatal:
        return ExercicioConstants.logLevelFatal;
    }
  }
  ...
  static ExercicioLoggerService get instance => _instance;
