...
//   }) async {
//     try {
//       final diagnosticosHive = await _hiveRepository.getAllAsync();
...
//     try {
//       final diagnosticoHive = await _hiveRepository.getByIdAsync(id);
...
//     try {
//       final allDiagnosticos = await _hiveRepository.getAllAsync();
...
//       final stats = DiagnosticosStats(
//         totalDiagnosticos: allDiagnosticos.length,
//         diagnosticosPorDefensivo: {},
//         diagnosticosPorCultura: {},
//         diagnosticosPorPraga: {},
//         topDiagnosticos: [],
//         estatisticasDosagem: DosageStats(
//           dosagemMinima: 0.0,
//           dosagemMaxima: 0.0,
//           dosagemMedia: 0.0,
//         ),
